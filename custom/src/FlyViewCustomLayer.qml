...
Item {
    ...
    QGCGroupBox {
        id: detectorDropdown
        anchors.left: emitterDropdown.right
        anchors.top: statusBar.bottom
        anchors.topMargin: _toolsMargin/2
        ...
        ColumnLayout{
            ...
            RowLayout {
                ...
                QGCLabel {
                    id:             detectorHeader
                    text:           (detectorExpanded ? "▼ " : "▶ ") + "Detector Info"
                    font.pointSize: ScreenTools.smallFontPointSize
                    font.bold:      true
    ...
    QGCGroupBox{
        ...
        ColumnLayout {
            ...
            QGCButton {
                Layout.fillWidth: true
                text: "Send Scan Settings"
                onClicked: backend.scanSettings()
                enabled: backend.isScanSettingsButtonEn
            }
