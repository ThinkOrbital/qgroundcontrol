...
DECLARE_SETTINGSFACT(CustomSettings, flightVel)
DECLARE_SETTINGSFACT(CustomSettings, goalLat)
DECLARE_SETTINGSFACT(CustomSettings, goalLon)
DECLARE_SETTINGSFACT(CustomSettings, startLat)
DECLARE_SETTINGSFACT(CustomSettings, startLon)
DECLARE_SETTINGSFACT(CustomSettings, endLat)
DECLARE_SETTINGSFACT(CustomSettings, endLon)
