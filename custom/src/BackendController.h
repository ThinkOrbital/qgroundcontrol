...
class BackendController : public QObject {
    ...
    Q_PROPERTY(bool isScanSettingsButtonEn READ isScanSettingsButtonEn WRITE setScanSettingsButtonEn NOTIFY scanSettingsButtonChanged)
...
public:
    ...
    bool isScanSettingsButtonEn() const {return this->isScanSettingsButtonEn_; }
    ...
    Q_INVOKABLE void setScanSettingsButtonEn(const bool enabled);
...
signals:
    ...
    void scanSettingsButtonChanged();
...
private:
    ...
    bool isScanSettingsButtonEn_ = {false};
    ...
    //detector settings
    uint64_t det_xray_window_ms_ {500};
