...
set(QGC_MAVLINK_GIT_REPO "git@github.com:ThinkOrbital/mavlink.git" CACHE STRING "" FORCE)
set(QGC_MAVLINK_GIT_TAG "master" CACHE STRING "" FORCE)
set(QGC_MAVLINK_DIALECT "all_with_coop" CACHE STRING "" FORCE)
set(QGC_MAVLINK_VERSION "2.0" CACHE STRING "" FORCE)

# Force CMake to re-fetch on every configure
# set(FETCHCONTENT_UPDATES_DISCONNECTED OFF CACHE BOOL "" FORCE)


message(STATUS "Using custom MAVLink: ${QGC_MAVLINK_GIT_REPO} @ ${QGC_MAVLINK_GIT_TAG}")
message(STATUS "MAVLink dialect: ${QGC_MAVLINK_DIALECT}")
# ----------------------------------------------------------------------------
